...
- mario_like_game/shepard_illusion_game/	🎮 Main Unity project – open this in Unity Hub
- mario_like_game/unity-super-mario-tutorial-main/	📚 Base tutorial (source: zigurous/unity-super-mario-tutorial)
- shepard/	🔊 Python scripts for Shepard tone visualization (generates 4 figures)
- depth_illusion_pyvideo/	🎥 Manim animation explaining perspective (output: PerspectiveFirstPrinciples.mp4)
